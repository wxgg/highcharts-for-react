...
var _highcharts = require('highcharts/highcharts.js');
...
var HighchartsCore = function (_Component) {
    _inherits(HighchartsCore, _Component);

    function HighchartsCore(props) {
        _classCallCheck(this, HighchartsCore);

        var _this = _possibleConstructorReturn(this, (HighchartsCore.__proto__ || Object.getPrototypeOf(HighchartsCore)).call(this, props));

        _this.createChart = function (options) {
            try {
                if (options) {
                    // 图表初始化函数
                    _this.highcharts = _highcharts2.default.chart(_this.container, options);
...
HighchartsCore.propTypes = propTypes;
HighchartsCore.defaultProps = defaultProps;
var _default = HighchartsCore;
...
(function () {
    ...
    reactHotLoader.register(propTypes, 'propTypes', 'js/Highcharts.js');
    reactHotLoader.register(defaultProps, 'defaultProps', 'js/Highcharts.js');
    reactHotLoader.register(HighchartsCore, 'HighchartsCore', 'js/Highcharts.js');
    reactHotLoader.register(_default, 'default', 'js/Highcharts.js');
    leaveModule(module);
})();
