...
var _highstock = require('highcharts/highstock.js');
...
var HighchartsStockCore = function (_Component) {
    _inherits(HighchartsStockCore, _Component);

    function HighchartsStockCore(props) {
        _classCallCheck(this, HighchartsStockCore);

        var _this = _possibleConstructorReturn(this, (HighchartsStockCore.__proto__ || Object.getPrototypeOf(HighchartsStockCore)).call(this, props));

        _this.createChart = function (options) {
            try {
                if (options) {
                    // 图表初始化函数
                    _this.highcharts = _highstock2.default.stockChart(_this.container, options);
    ...
    _createClass(HighchartsStockCore, [{
    ...
    return HighchartsStockCore;
}(_react.Component);

HighchartsStockCore.propTypes = propTypes;
HighchartsStockCore.defaultProps = defaultProps;
var _default = HighchartsStockCore;
...
(function () {
    ...
    reactHotLoader.register(propTypes, 'propTypes', 'js/HighchartsStock.js');
    reactHotLoader.register(defaultProps, 'defaultProps', 'js/HighchartsStock.js');
    reactHotLoader.register(HighchartsStockCore, 'HighchartsStockCore', 'js/HighchartsStock.js');
    reactHotLoader.register(_default, 'default', 'js/HighchartsStock.js');
    leaveModule(module);
})();
