...
import { HighchartsStock, HighchartsMap } from  '../dist/index.js';
        ...
        return ( <div >
            ...
            <HighchartsMap 
                ...
                options = { {
                    ...
                    series : [{
                            name: 'UTC',
                            data: Highchart.map(['IE', 'IS', 'GB', 'PT'], function (code) {
                                    return { code: code };
                            })
                    }, {
                            name: 'UTC + 1',
                            data: Highchart.map(['NO', 'SE', 'DK', 'DE', 'NL', 'BE', 'LU', 'ES', 'FR', 'PL', 'CZ', 'AT', 'CH', 'LI', 'SK', 'HU',
                                                                        'SI', 'IT', 'SM', 'HR', 'BA', 'YF', 'ME', 'AL', 'MK'], function (code) {
                                    return { code: code };
                            })
                    }, {
                            name: 'UTC + 2',
                            data: Highchart.map(['FI', 'EE', 'LV', 'LT', 'BY', 'UA', 'MD', 'RO', 'BG', 'GR', 'TR', 'CY'], function (code) {
                                    return { code: code };
                            })
                    }, {
                            name: 'UTC + 3',
                            data: Highchart.map(['RU'], function (code) {
                                    return { code: code };
                            })
                    }]
            }}
